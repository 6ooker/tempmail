...
// @ts-nocheck
    ...
    const url = "https://post.cbdrik.de"
    ...
    async function generateEmail(reload) {
        ...
        receivingEmail.set(words[0] + "." + words[1] + Math.floor(Math.random() * 1000) + "@cbdrik.de")
        ...
        <div class="text-center p-4 p-lg-5">
            ...
            <p class="text-start" style="margin-bottom: 4px;font-size: 16px;">
                ...
                <span class="float-end">
                    ...
                    <!--sse-->
                    <a href="mailto:support@cbdrik.de" style="color: inherit;">Contact</a>
                    <!--/sse-->
                </span>
            </p>
            <p class="text-start" style="margin-bottom: 4px;font-size: 16px;">
